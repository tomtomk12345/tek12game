 ...
 */
enum SFASSETTYPE {SFASSET_DEAD, SFASSET_PLAYER, SFASSET_PROJECTILE, SFASSET_CARROT,
SFASSET_FOX, SFASSET_WALL, SFASSET_VERTWALL, SFASSET_WALL2, SFASSET_VERTWALL2, SFASSET_YOUWIN};
