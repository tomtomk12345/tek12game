 ...
 */
enum SFEVENT {SFEVENT_NULL, SFEVENT_QUIT, SFEVENT_UPDATE, SFEVENT_PLAYER_LEFT,
 SFEVENT_PLAYER_RIGHT, SFEVENT_PLAYER_UP, SFEVENT_PLAYER_DOWN, SFEVENT_FIRE, SFEVENT_COLLISION, SFEVENT_LAST};
